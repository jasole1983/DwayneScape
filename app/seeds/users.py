...
def seed_users():
    ...
    WD1 = Deck(
        title="Wrestling 101", category="Wrestling", user=bobbie, id=10001
    )
    ...
    ELD1 = Deck(
        title="Family and School", category="Early-Life", user=marnie, id=10002
    )
    ...
    MV1 = Deck(
        title="Movie Facts", category="Movies", user=mike, id=10003
    )
    ...
    FF1 = Deck(
        title="Fast and Furious", category="Movies", user=mike, id=10004
    )
    ...
    TRV1 = Deck(
        title="Random!", category="Trivia", user=marnie, id=10005
    )
    ...
    TV1 = Deck(
        title="Young Rock", category="TV", user=bobbie, id=10006
    )
