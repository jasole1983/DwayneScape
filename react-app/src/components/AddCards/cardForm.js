...
export const CardForm = ({ card }) => {
    ...
    return (
        <li className="row" key={cardx}>
            ...
            <textarea key={cardx} placeholder={card.cardx.question} value={card.cardx.question} className="qan"></textarea>
            <textarea key={cardx} placeholder={card.cardx.answer} value={card.cardx.answer} className="qan"></textarea>
